  ...
  <footer
    ...
    <div>
      ...
      <div class="flex-col items-center xlg:box-border my-3">
        ...
        <section class="xlg:float-right flex-col my-2 mx-5 py-1 px-10 text-center xlg:text-left xlg:border-l-2">
      ...
      <p class="mt-3 py-2 mx-4 px-5 text-center text-sm clear-both">
